...
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$0vxWdeVgd2aKMh01b748EQ$4FwwwFvGLfK+r+8boOMBuw'
...
#  Choices: any of ['sha256', 'sha3_224', 'sha384', 'blake2b', 'sha512', 'sha224', 'blake2s', 'sha3_384', 'sha3_512', 'sha1', 'sha3_256', 'md5']
#  Default: 'sha256'
